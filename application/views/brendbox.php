<div class="brands">
		<div class="container" style="padding:0;margin:0 auto;">
			<div class="row">
				<div class="col-md-4" id="dcb-mobile"  style="margin-top:45px;">
					<h2><b style="color:#079dbf">Linzalar.az</b>-da satılan brendlər</h2>
					<p>...</p>
				</div>
				<div class="col-md-8">
					<div class="b_box">
						...
						<div class="b_f_box">
							<img src="<?php echo base_url('upload/')?>rimlux.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
