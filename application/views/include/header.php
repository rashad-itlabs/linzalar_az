...
<div class="mobileHeader">
	...
	<div class="draver">
		...
		<ul id="draverMenu">
			<?php  if($this->session->email) { ?>
				<li><a href="<?php echo base_url('order')?>"><span><i class="fas fa-dolly"></i></span> Mənim səbətim</a></li>
			<?php	}else{ ?>
		...
		<ul id="draverMenu" class="draverMenu">
			<li><a href="javascript::void"><span><i class="fas fa-globe-americas"></i></span>Az/Ru</a>
				<ul id="mod-dropdown">
					<li><a href="<?php echo base_url('ru')?>">Ru</a></li>
				</ul>
			</li>
			<li ><a href="javascript::void"><span><i class="fas fa-globe"></i></span> Markalar</a></li>
			<?php
			...
			<li><a href="javascript::void"><span><i class="far fa-circle"></i></span> Linza növləri</a></li>
			<?php
			...
			<li><a href="<?php echo base_url('category/linza-suyu')?>"><span><i class="fas fa-tint"></i></span> Linza Suları</a></li>

			<li><a href="<?php echo base_url('category/goz-damcisi')?>"><span><i class="fas fa-eye-dropper"></i></span> Göz damcısı</a></li>
					
					
			<li><a href="javascript::void"><span><i class="far fa-clock"></i></span> Optik çərçivələr</a></li>
			<?php
			...
			<li><a href="<?php echo base_url('bookmark')?>"><span><i class="far fa-star"></i></span> Seçilmiş Məhsullar</a></li>
			<li><a href="<?php echo base_url('kompaniya')?>"><span><i class="fas fa-tag"></i></span> Kampaniyalar</a></li>
			<?php  if($this->session->email) { ?>
				<li><a href="<?php echo base_url('home/logout')?>"><span><i class="fas fa-sign-out-alt"></i></span> Etibarlı çıxış</a></li>
			<?php	}else{ ?>
				<li><a href="<?php echo base_url('login')?>"><span><i class="fas fa-sign-in-alt"></i></span> Şəxsi kabinetə giriş</a></li>
			<?php	}
	...
	<div class="mobHeader">
		...
		<div id="logo"><a href="<?php echo base_url()?>"><img src="<?php echo base_url('public/')?>images/yatay.jpg" alt=""></a></div>
		<div id="header_link">
			<?php 
		...
		<?php }
			...
			<a href="<?php echo base_url('card')?>"><img src="<?php echo base_url('public/')?>images/icons/shopping-cart.png" alt="">
	...
	<div class="call_me">
		<a href="" data-toggle="modal" data-target=".bd-example-modal-lg">
			<img src="<?php echo base_url('public/')?>images/call_me_az.jpg" alt="">
		</a>
	</div>
	<div class="w_app">
	...
	<header>
		...
		<div class="dcb_header">
			<div id="dcb_items">
				<div id="logo">
					<a href="<?php echo base_url('/')?>"><img src="<?php echo base_url('public/')?>images/yatay.jpg" alt=""></a>
				</div>
			</div>
			<div id="dcb_items">
					<input type="text" id="myInput" class="form-control" placeholder="Açar sözə görə axtar...">
					...
					<?php
						if($this->session->email){ ?>
							...
							<div class="profileDropdown" data-labelable="dcbdropdownMenuLink">
								<a href="<?php echo base_url('order')?>"><i class="fas fa-dolly"></i> Mənim səbətim</a>
								<div class="dropdown-divider"></div>
								<a href="<?php echo base_url('home/logout')?>"><i class="fas fa-sign-out-alt"></i> Etibarlı çıxış</a>
							</div>
	...
	<div class="dcb_navbar dropmenu" id="navbar">
		<div class="dcb-nav">
			<ul id="dcb_menu">
				<li><a href="javascript::void" id="dcb_active" dropdown-toggle  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-format-list-bulleted"></i>&nbsp; Bütün Məhsullar</a></li>
				<?php 
					foreach ($navbarmenu as $key) { 

					?>
						<li class="<?php echo active_link('category/'.$key->seflink)?>"><a href="<?php echo base_url('category/'.$key->seflink)?>"><?php echo $key->menu_name?></a></li>
				<?php	}
				?>
				<?php
					if($komAlert){ ?>

						<li id="kampaniya"><a href="<?php echo base_url('kompaniya')?>">Kampaniyalar <span id="notifi"><i class="fas fa-bell"></i></span></a></li>

				<?php	}else{ ?>

					<li id="kampaniya"><a href="<?php echo base_url('kompaniya')?>">Kampaniyalar </a></li>
			...
			<div class="dcb_language">
				<div class="btn-group">
				  <a style="cursor:pointer;" id="lang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				    Az <i class="fas fa-chevron-down"></i>
				  </a>
				  <div class="dropdown-menu">
				    <a class="dropdown-item" href="<?php echo base_url('ru')?>">Rus</a>
				  </div>
				</div>
			</div>
						...
						<div class="col-md-8 dcb_alt_category">
							<div class="row">
								...
								<div class="col-md-4">
									...
									<ul id="dropMenu_list">
										<li class="disabled">Linza növləri</li>
										<?php
											foreach ($lenstype as $row) { ?>
												<li><a href="<?php echo base_url('category/'.$row->type_seflink)?>"><?php echo $row->lens_name?></a></li>
										<?php }
								...
								<div class="col-md-4">
									<ul id="dropMenu_list">
										<li class="disabled">Optik şüşələr</li>
										<li><a href="">Rimlux(1.5, 1.61, 1.67, 1.74)</a></li>
									</ul>
									<ul id="dropMenu_list">
										<li class="disabled">İstehsalçılar</li>
										<?php
											foreach ($brands as $row) { ?>
												<li><a href="<?php echo base_url('brend/'.$row->marka_seflink)?>"><?php echo $row->marka_name?></a></li>
										<?php }
									...
									<ul id="dropMenu_list">
										<li class="disabled">Optik çərçivələr</li>
										<?php
											foreach ($uselens as $row) { ?>
												<li><a href=""><?php echo $row->use_lens_name?></a></li>
										<?php }
							...
							foreach ($onePro as $row) { 
								...
								<div class="col-md-4 dcp_Product">
									<div class="card" style="text-align:center;width: 18rem;margin-left:15px;">
									  ...
									  <a href="<?php echo base_url('show_detail/'.$row->seflink)?>" class="btn btn-primary"><i class="fas fa-cart-plus"></i> Səbətə at</a>
									</div>
								</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Yeni Qeydiyyat</h5>
      ...
      <div class="modal-body">
        <div class="form-group">
        	...
        	<input type="text" name="name" required="required" class="form-control" placeholder="Ad">
        </div>
        <div class="form-group">
        	<span id="form-icon"><i class="fas fa-caret-right"></i></span>
        	<input type="text" name="surname" required="required" class="form-control" placeholder="Soyad">
        </div>
        <div class="form-group">
        	<span id="form-icon"><i class="fas fa-caret-right"></i></span>
        ...
        <div class="form-group">
        	...
        	<input type="text" name="adress" class="form-control" placeholder="Ünvan">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        	<label>Xüsusi kampaniyalaradan xəbərdar olmaq istəyirəm</label>
        	<br>
			<input 	type="radio" name="news" value="Bəli"> <small>Bəli</small>
			&nbsp;
			<input  type="radio" name="news" checked="checked" value="Yox"> <small>Xeyr</small>
		</div>
        <div class="form-group">
        	<button class="btn btn-primary" id="btn_register">Qeydiyyatdan keç</button>
        	
        </div>
        <small>Qeydiyyatınız var isə <a href="<?php echo base_url('login')?>">Giriş</a> edin</small>
      </div>
      </form>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <table id="callQuery">
      	<tr>
      		<td>
      			<div class="form-goup">
      				<label for="">Ad <span style="color:red">*</span></label>
      		...
      		<td>
      			<div class="form-goup">
      				<label for="">Soyad <span style="color:red">*</span></label>
      	...
      	<tr>
      		<td>
      			<div class="form-goup">
      				<label for="">Mövzu <span style="color:red">*</span></label>
      	...
      	<tr>
      		<td colspan="2">
      			<div class="form-goup">
      				<br>
      				<button id="send_call" class="btn btn-primary">Göndər</button>
      			</div>
      		</td>
      	</tr>
      </table>
