...
$('#btn_register').on('click',function(e){
	...
	var URL = $('#url').val();
	$.ajax({
		url:URL+"home/create_account",
		method:'POST',
		data:$('form').serialize(),
		dataType:'html',
		beforeSend:function(){
			$('#btn_register').text("Bir qədər gözləyin...");
		...
		success:function(r){
			if(r==1){
				...
				$('#btn_register').text("Qeydiyyatdan keç");
...
$(function(){
	$('#linzatype').change(function(){
		var val = $('#linzatype').val();
		var URL = $('#url').val();
		$.ajax({
			url:URL+"home/lens_price",
			method:'POST',
			data:{'val':val},
			success:function(data){
				$('#lens_price').html(data);
			}
		})
	})
});
...
$(function(){
	$('#linzatypeModel').change(function(){
		var val = $('#linzatypeModel').val();
		var URL = $('#url').val();
		$.ajax({
			url:URL+"home/lens_price",
			method:'POST',
			data:{'val':val},
			success:function(data){
				$('#lens_price_modal').html(data);
				jQuery("input[name='lens_price_modal']").val(data);
			}
		})
	})
});
...
$(function(){
	$('#btn_recete').on('click',function(){
		var val = $('#linzatype').val();
		$('.my-modal').fadeIn();
		$('#brand_title').text(val);
		$('#brandTitle').val(val);
	});
